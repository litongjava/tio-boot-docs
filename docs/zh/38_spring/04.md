...
```xml
  <properties>
    ...
    <main.class>nexus.io.spring.boot.tio.boot.demo01.Applicaton</main.class>
  </properties>
...
```java
package nexus.io.spring.boot.tio.boot.demo01;
...
```java
package nexus.io.spring.boot.tio.boot.demo01.config;
...
import nexus.io.jfinal.spring.SpringBeanContextUtils;
import nexus.io.spring.boot.tio.boot.demo01.Application;
...
```java
package nexus.io.spring.boot.tio.boot.demo01.service;
...
```java
package nexus.io.spring.boot.tio.boot.demo01.controller;

import java.util.List;
import nexus.io.jfinal.aop.Aop;
import nexus.io.jfinal.plugin.activerecord.Row;
import nexus.io.spring.boot.tio.boot.demo01.service.UserService;
...
```java
package nexus.io.spring.boot.tio.boot.demo01.services;
