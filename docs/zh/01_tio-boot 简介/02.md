...
<properties>
  ...
  <jfinal-aop.version>1.3.0</jfinal-aop.version>
...
```java
package com.red.book.test.controller;
...
```java
package com.red.book.test.handler;
...
```java
package com.red.book.test.config;
...
import com.red.book.test.handler.HelloHandler;
...
```java
package com.red.book.test;

import com.litongjava.tio.boot.TioApplication;
import com.red.book.test.config.WebHelloConfig;
