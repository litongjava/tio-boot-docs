...
- [Maven Central 上的 TioBoot](https://central.sonatype.com/artifact/nexus.io/tio-boot)
...
<properties>
  ...
  <main.class>nexus.io.test.HelloApp</main.class>
</properties>
...
import nexus.io.tio.boot.TioApplication;
import nexus.io.test.config.WebHelloConfig;
