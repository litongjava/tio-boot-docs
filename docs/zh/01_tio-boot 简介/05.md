...
有时会出现下面的错误,这是因为 fastjson 缓存的实体的 class 文件是旧的类加载器加载的文件

```log
java.lang.ClassCastException: com.litongjava.maxkb.vo.CredentialVo cannot be cast to com.litongjava.maxkb.vo.CredentialVo
	at com.alibaba.fastjson2.reader.ORG_3_7_ModelVo.readObject(Unknown Source)
