...
```xml
<java-model.version>1.1.3</java-model.version>
<tio-utils.version>3.7.3.v20241013-RELEASE</tio-utils.version>
...
<api-table.version>1.4.7</api-table.version>
<java.java-openai>1.1.1</java.java-openai>
```
