...
```xml
  <properties>
    ...
    <java-model.version>1.2.2</java-model.version>
    <tio-utils.version>3.7.3.v20251001-RELEASE</tio-utils.version>
    <tio-boot.version>2.0.3</tio-boot.version>
    <jfinal-aop.version>1.3.8</jfinal-aop.version>
    <java-db.version>1.5.5</java-db.version>
    <api-table.version>1.5.6</api-table.version>
    <java-openai.version>1.2.4</java-openai.version>
