...
```java
package nexus.io.college.hawaii.kapiolani;

import org.junit.Test;

import nexus.io.jfinal.aop.Aop;
import nexus.io.max.search.config.AdminAppConfig;
import nexus.io.maxkb.service.kb.MaxKbParagraphRetrieveService;
...
import nexus.io.jfinal.aop.Aop;
import nexus.io.max.search.callback.SearchGeminiSseCallback;
import nexus.io.max.search.callback.SearchPerplexiticySeeCallback;
import nexus.io.max.search.can.ChatWsStreamCallCan;
import nexus.io.max.search.consts.FocusMode;
import nexus.io.max.search.consts.SearchTableNames;
import nexus.io.max.search.model.MaxSearchChatMessage;
import nexus.io.max.search.model.MaxSearchChatSession;
import nexus.io.max.search.vo.ChatParamVo;
import nexus.io.max.search.vo.ChatReqMessage;
import nexus.io.max.search.vo.ChatWsReqMessageVo;
import nexus.io.max.search.vo.ChatDeltaRespVo;
import nexus.io.max.search.vo.CitationsVo;
