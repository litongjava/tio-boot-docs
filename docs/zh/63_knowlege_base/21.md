...
import nexus.io.maxkb.model.MaxKbSentence;
...
修改 nexus.io.maxkb.service.kb.MaxKbDatasetHitTestService.embeddingSearch(Long, Long, String, Double, Integer) 中的调用 sql 的代码,修改成下面的形式
