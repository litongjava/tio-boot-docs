...
在的 `pom.xml` 文件中添加 Playwright 的依赖：
...
```java
package nexus.io.perplexica.instance;
...
```java
package nexus.io.maxkb.playwright;
...
import nexus.io.annotation.RequestPath;
import nexus.io.playwright.instance.PlaywrightBrowser;
