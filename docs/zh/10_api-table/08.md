...
@NoArgsConstructor
@AllArgsConstructor
public class ExcelImportStudentVo {
  private String name;
...
public class StudentService {
  ...
  public RespBodyVo importByAppId(Long appId, byte[] data) {
    ...
    List<ExcelImportStudentVo> list = EasyExcel.read(byteArrayInputStream)
...
假设我们上传了一个包含学生姓名和邮箱的 Excel 文件，接口返回的数据如下：
