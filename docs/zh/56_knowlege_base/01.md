...
CREATE INDEX "application_model_id" ON max_kb_application USING btree (
  "model_id"ASC NULLS LAST
);

CREATE INDEX "application_stt_model_id" ON max_kb_application USING btree (
  "stt_model_id"ASC NULLS LAST
);

CREATE INDEX "application_tts_model_id" ON max_kb_application USING btree (
  "tts_model_id"ASC NULLS LAST
);

CREATE INDEX "application_user_id" ON max_kb_application USING btree (
...
```sql
drop table if exists max_kb_file;
...
CREATE INDEX "max_kb_problem_dataset_id" ON "max_kb_problem" USING btree (
...
```sql
CREATE TABLE "max_kb_problem_paragraph_mapping" (
  "id" BIGINT PRIMARY KEY,
  "dataset_id" bigint NOT NULL,
  "document_id" bigint NOT NULL,
...
CREATE INDEX "max_kb_problem_paragraph_mapping_dataset_id" ON "max_kb_problem_paragraph_mapping" USING btree (
  "dataset_id" ASC NULLS LAST
);

CREATE INDEX "max_kb_problem_paragraph_mapping_document_id" ON "max_kb_problem_paragraph_mapping" USING btree (
  "document_id" ASC NULLS LAST
);

CREATE INDEX "max_kb_problem_paragraph_mapping_paragraph_id" ON "max_kb_problem_paragraph_mapping" USING btree (
  "paragraph_id" ASC NULLS LAST
);

CREATE INDEX "max_kb_problem_paragraph_mapping_problem_id" ON "max_kb_problem_paragraph_mapping" USING btree (
...
```sql
drop table if exists max_kb_document_markdown_cache;
...
```sql
CREATE TABLE "max_kb_document_markdown_page_cache" (
  "id" "varchar" primary key,
  "target" "varchar",
  "content" text,
  "elapsed" bigint,
...
max_application_chat

```sql
drop table if exists max_kb_application_chat;
create table max_application_chat(
  "id" bigint primary key,
  "abstract" "varchar",
  "application_id" bigint NOT NULL,
  "client_id" bigint,
...
CREATE INDEX "max_kb_application_chat_application_id" ON max_kb_application_chat USING btree (
...
```sql
drop table if exists max_kb_application_chat_record;
CREATE TABLE "max_kb_application_chat_record" (
  "id" bigint primary key,
...
```sql
drop table if exists max_kb_application_temp_setting;
create table max_kb_application_temp_setting(
  "id" bigint primary key,
  "setting" "jsonb"
);
```
