...
首先，在的项目的 `pom.xml` 文件中添加 `tio-boot-admin` 的依赖：
...
```xml
  <properties>
    ...
    <tio-boot-admin.version>2.1.2</tio-boot-admin.version>

    <!-- 应用程序属性 -->
    <final.name>web-hello</final.name>
    <main.class>nexus.io.ai.devops.bot.AiDevoptsBotApp</main.class>
  </properties>
...
这将引入 `tio-boot-admin` 的核心库，确保能够使用其提供的功能和接口。
...
```java
package nexus.io.ai.devops.bot.config;
...
```java
package nexus.io.ai.devops.bot;

import nexus.io.ai.devops.bot.config.AdminAppConfig;
import nexus.io.tio.boot.TioApplication;

public class AiDevoptsBotApp {
  public static void main(String[] args) {
    long start = System.currentTimeMillis();
    TioApplication.run(AiDevoptsBotApp.class, new AdminAppConfig(), args);
...
2024-10-30 10:12:55.437 [main] INFO  c.l.t.b.c.TioApplicationContext.run:143 - used cache :class nexus.io.tio.utils.cache.mapcache.ConcurrentMapCacheFactory
...
2024-10-30 10:12:56.707 [main] INFO  c.l.t.u.Threads.getTioExecutor:93 - new worker thead pool:nexus.io.tio.utils.thread.pool.SynThreadPoolExecutor@28dcca0c[Running, pool size = 1, active threads = 1, queued tasks = 0, completed tasks = 0]
2024-10-30 10:12:56.717 [main] INFO  c.l.t.b.c.TioApplicationContext.run:313 - http  mapping
{
  "/api/system/file/firebase/getUrl": "nexus.io.tio.boot.admin.config.TioAdminHandlerConfiguration$$Lambda$27/1904783235@1807e3f6",
  "/api/system/file/s3/md5": "nexus.io.tio.boot.admin.config.TioAdminHandlerConfiguration$$Lambda$24/1574877131@480d3575",
  "/api/accountSettingCurrentUser": "nexus.io.tio.boot.admin.config.TioAdminHandlerConfiguration$$Lambda$20/1040776996@f1da57d",
  "/api/currentUser": "nexus.io.tio.boot.admin.config.TioAdminHandlerConfiguration$$Lambda$19/725680028@194fad1",
  "/api/event/add": "nexus.io.tio.boot.admin.config.TioAdminHandlerConfiguration$$Lambda$21/1293680734@26abb146",
  "/api/geographic/province": "nexus.io.tio.boot.admin.config.TioAdminHandlerConfiguration$$Lambda$29/2083999882@72c8e7b",
  "/api/login/validateLogin": "nexus.io.tio.boot.admin.config.TioAdminHandlerConfiguration$$Lambda$18/1158676965@65f8f5ae",
  "/api/system/file/url": "com.enote.admin.config.EnoteAdminAppConfig$$Lambda$32/1984513847@431cd9b2",
  "/api/sd/generateSd3": "nexus.io.tio.boot.admin.config.TioAdminHandlerConfiguration$$Lambda$30/611520720@38467116",
  "/api/fake_analysis_chart_data": "nexus.io.tio.boot.admin.config.TioAdminHandlerConfiguration$$Lambda$22/138817329@5b7a7f33",
  "/api/login/account": "nexus.io.tio.boot.admin.config.TioAdminHandlerConfiguration$$Lambda$16/2107443224@790da477",
  "/api/system/file/s3/url": "nexus.io.tio.boot.admin.config.TioAdminHandlerConfiguration$$Lambda$25/1894601438@5c7933ad",
  "/api/system/changeUserPassword": "nexus.io.tio.boot.admin.config.TioAdminHandlerConfiguration$$Lambda$28/1810458830@57bc27f5",
  "/api/login/outLogin": "nexus.io.tio.boot.admin.config.TioAdminHandlerConfiguration$$Lambda$17/572145572@5fb759d6",
  "/api/system/file/s3/upload": "nexus.io.tio.boot.admin.config.TioAdminHandlerConfiguration$$Lambda$23/609656250@4b8d604b",
  "/api/system/file/uploadToGoogle": "nexus.io.tio.boot.admin.config.TioAdminHandlerConfiguration$$Lambda$26/1497377679@5e7cd6cc",
...
{
  "/api/table/export-all-table-excel": "nexus.io.tio.boot.admin.controller.ApiTableController.exportAllTableExcel(request)",
  "/api/table/index": "nexus.io.tio.boot.admin.controller.ApiTableController.index()",
  "/api/table/names": "nexus.io.tio.boot.admin.controller.ApiTableController.tableNames()",
  "/api/table/{f}/batchUpdate": "nexus.io.tio.boot.admin.controller.ApiTableController.batchUpdate(f,request)",
  "/api/table/{f}/columns": "nexus.io.tio.boot.admin.controller.ApiTableController.proTableColumns(f)",
  "/api/table/{f}/config": "nexus.io.tio.boot.admin.controller.ApiTableController.fConfig(f,lang)",
  "/api/table/{f}/create": "nexus.io.tio.boot.admin.controller.ApiTableController.create(f,request)",
  "/api/table/{f}/delete/{id}": "nexus.io.tio.boot.admin.controller.ApiTableController.delete(f,id)",
  "/api/table/{f}/export-excel": "nexus.io.tio.boot.admin.controller.ApiTableController.exportExcel(f,request)",
  "/api/table/{f}/export-table-excel": "nexus.io.tio.boot.admin.controller.ApiTableController.exportAllExcel(f,request)",
  "/api/table/{f}/get": "nexus.io.tio.boot.admin.controller.ApiTableController.get(f,request)",
  "/api/table/{f}/list": "nexus.io.tio.boot.admin.controller.ApiTableController.list(f,request)",
  "/api/table/{f}/listAll": "nexus.io.tio.boot.admin.controller.ApiTableController.listAll(f)",
  "/api/table/{f}/page": "nexus.io.tio.boot.admin.controller.ApiTableController.page(f,request)",
  "/api/table/{f}/pageDeleted": "nexus.io.tio.boot.admin.controller.ApiTableController.pageDeleted(f,request)",
  "/api/table/{f}/recover": "nexus.io.tio.boot.admin.controller.ApiTableController.recover(f,id)",
  "/api/table/{f}/remove/{id}": "nexus.io.tio.boot.admin.controller.ApiTableController.remove(f,id)",
  "/api/table/{f}/total": "nexus.io.tio.boot.admin.controller.ApiTableController.total(f)",
  "/api/table/{f}/update": "nexus.io.tio.boot.admin.controller.ApiTableController.update(f,request)",
  "/mongodb/json/{f}/create": "nexus.io.tio.boot.admin.controller.MongodbController.create(f,request)",
  "/mongodb/json/{f}/delete/{id}": "nexus.io.tio.boot.admin.controller.MongodbController.delete(f,id)",
  "/mongodb/json/{f}/export-excel": "nexus.io.tio.boot.admin.controller.MongodbController.exportExcel(f,request)",
  "/mongodb/json/{f}/export-table-excel": "nexus.io.tio.boot.admin.controller.MongodbController.exportAllExcel(f,request)",
  "/mongodb/json/{f}/page": "nexus.io.tio.boot.admin.controller.MongodbController.page(f,request)"
}
...
`tio-boot-admin` 作为一个高效的后台管理框架，结合 `tio-boot` 的强大功能，能够帮助开发者快速搭建稳定、可扩展的管理系统。通过本文的入门示例，相信已经掌握了基本的集成和配置方法，接下来可以根据项目需求进行深入开发和定制。

如果在使用过程中遇到问题，欢迎参考 [tio-boot-admin 官方文档](https://github.com/litongjava/tio-boot-admin) 或在社区中寻求帮助。祝开发顺利！
