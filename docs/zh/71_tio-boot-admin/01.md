...
```xml
  <properties>
    ...
    <tio-boot-admin.version>2.0.9</tio-boot-admin.version>

    <!-- 应用程序属性 -->
    <final.name>web-hello</final.name>
    <main.class>com.litongjava.ai.devops.bot.AiDevoptsBotApp</main.class>
  </properties>
...
```java
package com.litongjava.ai.devops.bot.config;
...
```java
package com.litongjava.ai.devops.bot;

import com.litongjava.ai.devops.bot.config.AdminAppConfig;
