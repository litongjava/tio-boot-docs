...
```java
package nexus.io.im.server.config;
...
```java
package nexus.io.im.server.listener;
...
```java
package nexus.io.im.listener;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import nexus.io.aio.Packet;
import nexus.io.im.config.MyChatServerConstant;
import nexus.io.tio.core.ChannelContext;
...
import nexus.io.tio.websocket.server.WebSocketServerAioListener;
...
import nexus.io.im.server.constant.IpStatDuration;
import nexus.io.im.server.listener.MyIpStatListener;
...
```java
package nexus.io.im.server.handler;

import java.util.Objects;

import nexus.io.im.server.config.MyChatServerConstant;
import nexus.io.tio.core.ChannelContext;
import nexus.io.tio.core.Tio;
...
以上展示了一个 WebSocket 聊天室的基本实现和效果演示，能够在本地进行简单的多人聊天。可以通过打开多个浏览器窗口进行测试。
