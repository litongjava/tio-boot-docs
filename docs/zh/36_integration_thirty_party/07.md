...
[[toc]]
本文档介绍如何基于 Lark Mail 实现邮件发送功能。通过继承 Lark Mail 接口并调用内部封装的邮件发送工具，我们可以方便地对接 `smtp.larksuite.com` 的 SMTP 服务，实现邮件发送。下面将详细介绍如何在项目中集成及使用这一功能。
...
```java
package nexus.io.open.chat.mail;

import java.util.Properties;
import nexus.io.tio.utils.email.EMail;
import nexus.io.tio.utils.email.EMailSendUtils;
...
import nexus.io.tio.utils.email.EMail;
import nexus.io.tio.utils.email.IEMailFactory;
...
public class LarkSuitEmailUtilsTest {
  ...
  public void test() {
    EnvUtils.load();
    LarkSuitEmailUtils.send("litongjava001@gmail.com", "好", "好,的验证码是1234");
  }
}
```
...
import nexus.io.open.chat.mail.LarkSuitEmailUtils;
import nexus.io.open.chat.mail.LarkSuitMail;
...
import org.junit.Test;
import nexus.io.open.chat.config.LarkSuitMailConfig;
import nexus.io.tio.utils.environment.EnvUtils;
...
public class LarkSuitEmailUtilsTest {
  ...
  public void test() {
    ...
    LarkSuitEmailUtils.send("litongjava001@gmail.com", "好", "好,的验证码是1234");
    LarkSuitEmailUtils.send("litongjava001@gmail.com", "好", "好,的验证码是12346");
  }
}
```
