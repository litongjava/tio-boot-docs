...
Swagger 提供了一套完整的解决方案，用于描述、消费和可视化 RESTful Web 服务。通过与 Tio-Boot 的集成，开发者可以轻松生成和维护 API 文档，提升团队协作效率。本教程将带领一步步完成 Swagger 在 Tio-Boot 项目中的集成。
...
import nexus.io.tio.boot.http.handler.common.WebjarHandler;
import nexus.io.tio.boot.server.TioBootServer;
import nexus.io.tio.boot.swagger.SwaggerResourceHandler;
import nexus.io.tio.boot.swagger.SwaggerV2ApiDocsHandler;
import nexus.io.tio.boot.swagger.TioSwaggerV2Config;
import nexus.io.tio.http.server.router.HttpRequestRouter;
import nexus.io.tio.web.hello.controller.SwaggerUiHandler;
...
import nexus.io.tio.boot.utils.HttpBasicAuthUtils;
...
```java
package nexus.io.tio.web.hello.model;
...
import nexus.io.tio.web.hello.model.LabelAndCityResponse;
import nexus.io.tio.web.hello.model.SendComplaintRequest;
