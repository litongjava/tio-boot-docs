...
import com.litongjava.manim.utils.McBuildErrorBot;
import com.litongjava.tio.utils.environment.EnvUtils;
import com.litongjava.tio.utils.notification.NotifactionWarmModel;

public class McBuildErrorBotTest {
  ...
  public void testPush() {
    ...
    McBuildErrorBot.sendWarm(model);
  }
}
...
- `model` 是NotifactionWarmModel,是要发送的消息内容模型。里面提供了丰富的参数设置
...
public class LarkBotQuestionUtils {
  public static final String APP_ID = "cli_xxxxx"; // 替换为的 APP ID
  public static final String APP_SECRET = "xxxx";    // 替换为的 APP Secret
...
- 该测试将向指定的 Lark 机器人发送一条 "好吗？" 的消息，确保集成工作正常。
