...
推荐版本：3.x
```bash
mkdir /opt/package/Kafka -p && cd /opt/package/Kafka 
...
```java
package nexus.io.mq.Kafka.config;

import nexus.io.annotation.AConfiguration;
import nexus.io.annotation.Initialization;
import nexus.io.hook.HookCan;
import nexus.io.mq.Kafka.KafkaConsumerHandler;
import nexus.io.mq.Kafka.KafkaProducerUtils;
...
### 7、KafkaTestController（HTTP 触发发送）

```java
package nexus.io.mq.Kafka.controller;

import nexus.io.annotation.RequestPath;
import nexus.io.mq.Kafka.KafkaProducerUtils;

@RequestPath("/Kafka/test")
