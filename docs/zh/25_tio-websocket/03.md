...
```
src/main/java
├─ nexus.io.websockify.config
│   └─ WebHelloConfig.java         # 启动配置：注册 WebSocket 路由
├─ nexus.io.websockify.handler
...
### WebHelloConfig
```java
package nexus.io.websockify.config;
...
import nexus.io.websockify.handler.IndexHandler;
import nexus.io.websockify.handler.WebsockifyHandler;
