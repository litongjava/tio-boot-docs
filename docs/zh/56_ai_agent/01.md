...
## llm_html_preview (大模型请求和响应记录)
```sql
drop table if exists llm_html_preview;
CREATE TABLE llm_html_preview (
  id BIGINT primary key,
  md5 varchar,
  html text,
  creator VARCHAR(64) DEFAULT '',
...
llm_document_parsed_file_cache

```sql
DROP TABLE IF EXISTS "public"."llm_document_parsed_file_cache";

CREATE TABLE "public"."llm_document_parsed_file_cache" (
  "id" bigint PRIMARY KEY,
  "md5" VARCHAR,
  "file_id" bigint,
  "output" jsonb,
...
```sql
DROP TABLE IF EXISTS "public"."ai_audio_asr_cache";

CREATE TABLE "public"."ai_audio_asr_cache" (
  "id" bigint PRIMARY KEY,
  "md5" VARCHAR,
  "file_id" bigint,
  "output" jsonb,
