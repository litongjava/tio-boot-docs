...
public class HelloWebSocketHandler implements IWebSocketHandler {
  ...
  public void onAfterHandshaked(HttpRequest httpRequest, HttpResponse httpResponse, ChannelContext channelContext)
    ...
    WsResponse wsResponse = WsResponse.fromText(message, CHARSET);
    // 广播消息给群组内所有用户
...
public interface IWebSocketHandler {
   ...
   * 处理 WebSocket 握手请求
   */
  HttpResponse handshake(HttpRequest httpRequest, HttpResponse httpResponse, ChannelContext channelContext)
      throws Exception;
