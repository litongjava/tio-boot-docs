...
public class RequestResponseStatisticsService {
  public void save(long id, String requestIp, String requestUri, String requestHeader, String contentType, String requestBody, int responseStatusCode, String responseBody, long elapsed) {
...
public class MyRequestResponseStatisticsHandler implements ResponseStatisticsHandler {
  ...
  public void count(HttpRequest request, RequestLine requestLine, HttpResponse httpResponse, Object userId, long elapsed) {
    ...
    String responseContentType = httpResponse.getContentType().toString();
    ...
    TioThreadUtils.getFixedThreadPool().submit(() -> {
      ...
      if (responseContentType != null && responseContentType.contains("application/json")) {
        responseBody = new String(httpResponse.getBody());
...
```json
{
  ...
  "elapsed": 218,
  "create_time": "2024-09-04T04:00:53.25183",
  "deleted": 0,
  "tenant_id": 0
}
```
