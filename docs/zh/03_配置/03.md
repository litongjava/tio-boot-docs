...
- **限制过期时间**：当需要在一定时间内缓存数据，且希望在不使用后自动过期。
...
```json
{
  "data": {
    ...
    "cache_nexus.io.tio.utils.lock.LockUtilsOBJ": {},
    "cache_nexus.io.tio.utils.lock.LockUtilsRW": {
    ...
    "map": {
      "nexus.io.tio.utils.lock.LockUtilsOBJ": {
        "cacheName": "nexus.io.tio.utils.lock.LockUtilsOBJ",
      ...
      "nexus.io.tio.utils.lock.LockUtilsRW": {
        "cacheName": "nexus.io.tio.utils.lock.LockUtilsRW",
        "timeToIdleSeconds": "3600",
        "timeToLiveSeconds": null
      },
