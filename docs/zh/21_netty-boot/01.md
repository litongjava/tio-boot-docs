...
<properties>
  ...
  <main.class>nexus.io.study.netty.boot.MainApp</main.class>
</properties>
...
import nexus.io.netty.boot.NettyApplication;
...
```java
package nexus.io.study.netty.boot.config;
...
import nexus.io.netty.boot.http.HttpRequestRouter;
import nexus.io.netty.boot.server.NettyBootServer;
import nexus.io.netty.boot.websocket.WebsocketRouter;
import nexus.io.study.netty.boot.handler.OkHandler;
import nexus.io.study.netty.boot.handler.Ws2Handler;
import nexus.io.study.netty.boot.handler.WsHandler;
...
```java
package nexus.io.study.netty.boot.handler;

import nexus.io.model.body.RespBodyVo;
import nexus.io.netty.boot.utils.HttpRequestUtils;
import nexus.io.netty.boot.utils.HttpResponseUtils;
...
```
INFO  nexus.io.study.netty.boot.handler.WsHandler - 连接加入: [id: 0x12345678, L:/127.0.0.1:80 - R:/127.0.0.1:54321]
INFO  nexus.io.study.netty.boot.handler.WsHandler - 连接移除: [id: 0x12345678, L:/127.0.0.1:80 - R:/127.0.0.1:54321]
```
