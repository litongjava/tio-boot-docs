...
<properties>
  ...
  <main.class>nexus.io.ip.baidu.BaiduAppServer</main.class>
</properties>
...
```java
package nexus.io.ip.baidu.client;
...
```java
package nexus.io.ip.baidu.consts;
...
```java
package nexus.io.ip.baidu.dao;

import nexus.io.db.activerecord.Db;
import nexus.io.db.activerecord.Row;
import nexus.io.ip.baidu.consts.TableNames;
...
```java
package nexus.io.ip.baidu.service;

import com.alibaba.fastjson2.JSONObject;
import nexus.io.ip.baidu.client.BaiduIpClient;
import nexus.io.ip.baidu.dao.BaiduIpDao;
...
import nexus.io.ip.baidu.utils.Ip2RegionUtils;
import nexus.io.ip.baidu.utils.IpRegionUtils;
import nexus.io.jfinal.aop.Aop;
...
```java
package nexus.io.ip.baidu.utils;
...
```java
package nexus.io.ip.baidu.handler;

import nexus.io.ip.baidu.service.IpService;
import nexus.io.jfinal.aop.Aop;
...
```java
package nexus.io.ip.baidu.config;
...
import nexus.io.annotation.AConfiguration;
import nexus.io.annotation.Initialization;
import nexus.io.ip.baidu.handler.IpHandler;
import nexus.io.tio.boot.server.TioBootServer;
