...
<properties>
  ...
  <main.class>nexus.io.tio.boot.sqllite.App</main.class>
</properties>
<dependencies>
  ...
  <!--https://central.sonatype.com/artifact/nexus.io/ApiTable-->
  <dependency>
...
```java
package nexus.io.tio.boo.demo.file;
...
```java
package nexus.io.tio.boo.demo.file.config;
...
import nexus.io.jfinal.plugin.activerecord.ActiveRecordPlugin;
import nexus.io.jfinal.plugin.activerecord.OrderedFieldContainerFactory;
import nexus.io.jfinal.plugin.activerecord.dialect.Sqlite3Dialect;
import nexus.io.jfinal.plugin.hikaricp.DsContainer;
...
```
package nexus.io.tio.boo.demo.file.model;
...
```
package nexus.io.tio.boo.demo.file.constants;
...
```java
package nexus.io.tio.boo.demo.file.services;
...
import nexus.io.tio.boo.demo.file.constants.AppConstants;
import nexus.io.tio.boo.demo.file.model.FileSaveResult;
...
```java
package nexus.io.tio.boo.demo.file.controller;
...
import nexus.io.jfinal.aop.annotation.AAutowired;
import nexus.io.tio.boo.demo.file.model.FileSaveResult;
import nexus.io.tio.boo.demo.file.services.FileService;
...
```
package nexus.io.file.server.requesthandler;
...
import nexus.io.file.server.model.FileSaveResult;
import nexus.io.file.server.services.FileService;
import nexus.io.jfinal.aop.annotation.AAutowired;
import nexus.io.tio.http.common.HttpRequest;
import nexus.io.tio.http.common.HttpResponse;
import nexus.io.model.upload.UploadFile;
...
### 使用配置类配置 RequestHandler

```
package nexus.io.file.server.config;

import nexus.io.file.server.requesthandler.FileRequestHandler;
import nexus.io.jfinal.aop.Aop;
import nexus.io.jfinal.aop.annotation.AInitialization;
import nexus.io.jfinal.aop.annotation.BeforeStartConfiguration;
import nexus.io.tio.boot.server.TioBootServer;
import nexus.io.tio.http.server.handler.SimpleHttpRoutes;
...
public class HttpServerRequestHandlerConfig {
  ...
  public void httpRoutes() {
    ...
    // 创建controller
    FileRequestHandler asrSubmitRequestHandler = Aop.get(FileRequestHandler.class);

    // 添加action
    simpleHttpRoutes.add("/upload", asrSubmitRequestHandler::upload);
    simpleHttpRoutes.add("/download", asrSubmitRequestHandler::download);
