...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 https://maven.apache.org/xsd/maven-4.0.0.xsd">
  ...
  <properties>
    ...
    <main.class>nexus.io.open.chat.OpenChatServer</main.class>
  </properties>
  <dependencies>
    <dependency>
...
```java
package nexus.io.open.chat;

import nexus.io.jfinal.aop.annotation.AComponentScan;
import nexus.io.open.chat.config.OpenChatServerConfig;
...
import nexus.io.tio.utils.thread.ThreadUtils;
...
import nexus.io.open.chat.handler.OpenaiV1ChatHandler;
import nexus.io.tio.boot.server.TioBootServer;
...
```java
package nexus.io.open.chat.constants;
...
```java
package nexus.io.open.chat.instance;
...
import nexus.io.open.chat.constants.OpenAiConstatns;
import nexus.io.open.chat.instance.OkHttpClientPool;
...
import nexus.io.open.chat.client.OpenAiClient;
import nexus.io.open.chat.constants.OpenAiConstatns;
import nexus.io.open.chat.services.OpenaiV1ChatService;
...
import nexus.io.tio.http.common.sse.SseBytesPacket;
import nexus.io.tio.http.server.util.HttpServerResponseUtils;
...
```java
package nexus.io.open.chat.services;
