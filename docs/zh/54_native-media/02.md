...
```
D:\java\jdk1.8.0_121\bin\javah -J-Dfile.encoding=UTF-8 -d jni -classpath src\main\java nexus.io.media.NativeMedia
```
...
```java
package nexus.io.media.utils;

import java.io.File;
import nexus.io.media.core.Core;
...
import nexus.io.media.utils.LibraryUtils;
