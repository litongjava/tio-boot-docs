...
```java
package nexus.io.perplexica.handler;

import com.alibaba.fastjson2.JSONObject;
import nexus.io.jfinal.aop.Aop;
import nexus.io.perplexica.services.WsChatService;
import nexus.io.perplexica.vo.ChatWsReqMessageVo;
import nexus.io.perplexica.vo.ChatWsRespVo;
...
import nexus.io.openai.consts.PerplexityConstants;
import nexus.io.openai.consts.PerplexityModels;
import nexus.io.perplexica.callback.PerplexiticySeeCallback;
import nexus.io.perplexica.callback.SearchGeminiSseCallback;
import nexus.io.perplexica.can.ChatWsStreamCallCan;
import nexus.io.perplexica.consts.FocusMode;
import nexus.io.perplexica.consts.SearchTableNames;
import nexus.io.perplexica.model.MaxSearchChatMessage;
import nexus.io.perplexica.model.MaxSearchChatSession;
import nexus.io.perplexica.vo.ChatParamVo;
import nexus.io.perplexica.vo.ChatReqMessage;
import nexus.io.perplexica.vo.ChatWsReqMessageVo;
import nexus.io.perplexica.vo.ChatWsRespVo;
import nexus.io.perplexica.vo.CitationsVo;
import nexus.io.perplexica.vo.WebPageSource;
...
import nexus.io.tio.utils.tag.TagUtils;
...
```java
package nexus.io.max.search.services;
...
import nexus.io.max.search.consts.OptimizationMode;
import nexus.io.max.search.vo.ChatParamVo;
import nexus.io.max.search.vo.ChatWsReqMessageVo;
import nexus.io.max.search.vo.ChatWsRespVo;
import nexus.io.max.search.vo.WebPageSource;
import nexus.io.model.web.WebPageContent;
import nexus.io.template.PromptEngine;
import nexus.io.tio.core.ChannelContext;
import nexus.io.tio.core.Tio;
...
import nexus.io.openai.chat.OpenAiChatRequestVo;
import nexus.io.openai.client.OpenAiClient;
import nexus.io.perplexica.callback.DeepSeekSseCallback;
import nexus.io.perplexica.vo.ChatParamVo;
import nexus.io.perplexica.vo.ChatWsReqMessageVo;
import nexus.io.perplexica.vo.ChatWsRespVo;
import nexus.io.tio.core.ChannelContext;
...
```java
package nexus.io.perplexica.callback;
