...
import nexus.io.manim.services.MathQuesitonService;
import nexus.io.manim.utils.MvThreadUtils;
...
如果希望我再补一版“带取消与超时”的增强实现（同时保持原错误码优先级不变），我也可以直接给出完整代码。

## 其他代码

### TioVirtualThreadUtils
```java
package nexus.io.manim.utils;
