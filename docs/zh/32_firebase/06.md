...
```java
package nexus.io.max.blog.dao;

import nexus.io.db.activerecord.Db;
import nexus.io.db.activerecord.Row;
import nexus.io.max.blog.consts.TableNames;
import nexus.io.tio.utils.encoder.Sha1Utils;
...
```java
package nexus.io.open.chat.dao;
...
```java
package nexus.io.max.blog.service;

import com.jfinal.kit.Kv;
import com.jfinal.template.Engine;
import com.jfinal.template.Template;
import nexus.io.max.blog.utils.MailJetUtils;
...
```java
package nexus.io.open.chat.config;
...
```java
package nexus.io.max.blog.controller;

import nexus.io.annotation.RequestPath;
import nexus.io.jfinal.aop.Aop;
import nexus.io.max.blog.service.UserLoginService;
import nexus.io.max.blog.service.UserPasswordService;
import nexus.io.max.blog.service.UserRegisterService;
import nexus.io.max.blog.vo.UserRegisterVo;
import nexus.io.max.blog.vo.UserResetVo;
...
import nexus.io.max.blog.inteceptor.AuthInterceptor;
...
import nexus.io.jfinal.aop.Aop;
import nexus.io.max.blog.consts.TableNames;
import nexus.io.max.blog.dao.MaxBlogUserDao;
import nexus.io.max.blog.vo.UserRegisterVo;
import nexus.io.model.body.RespBodyVo;
...
```java
package nexus.io.open.chat.services.user;
...
import nexus.io.model.body.RespBodyVo;
import nexus.io.max.blog.dao.MaxBlogUserDao;
import nexus.io.open.chat.dao.ResetPasswordCodeDao;
import nexus.io.open.chat.model.UserResetVo;
import nexus.io.max.blog.service.EmailService;
...
import nexus.io.open.chat.config.EnjoyEngineConfig;
import nexus.io.open.chat.config.FirebaseAppConfiguration;
import nexus.io.open.chat.model.UserRegisterVo;
import nexus.io.tio.utils.environment.EnvUtils;
...
import nexus.io.open.chat.config.FirebaseAppConfiguration;
import nexus.io.open.chat.model.UserResetVo;
import nexus.io.open.chat.services.user.UserPasswordService;
import nexus.io.tio.utils.environment.EnvUtils;
import nexus.io.tio.utils.json.JsonUtils;
