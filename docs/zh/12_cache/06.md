...
- nexus.io.tio.utils.cache.caffeine.CaffeineCache
- nexus.io.tio.utils.cache.guava.GuavaCache
- nexus.io.tio.utils.cache.caffeineredis.CaffeineRedisCache
- nexus.io.tio.utils.cache.guavaredis.GuavaRedisCache
- nexus.io.tio.utils.cache.j2cache.J2Cache
- nexus.io.tio.utils.cache.redis.RedisCache

下面演示一下 CaffeineCache,RedisCache,CaffeineRedisCache 的使用

### CacheUtils

nexus.io.tio.utils.cache.CacheUtils 提供了 get 方法,方法签名如下
...
CacheName,使用默认的 nexus.io.tio.utils.cache.CacheName
CacheNameService,使用默认的 nexus.io.tio.utils.cache.CacheNameService
...
```
package nexus.io.tio.boot.hello.config;
