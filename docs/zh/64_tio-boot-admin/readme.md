...
Redis 连接与字符串操作见 [20：整合 Redis](./20.md)。17 是历史可选方案，默认接入不需要 Sa-Token。业务联调、路由鉴权和开发规范分别见 18、19、22。
...
- [04：整合数据库](./04.md)
- [05：与前端集成](./05.md)
- [06：文件上传：UniStorageService 与前端集成](./06.md)
- [07：网络请求](./07.md)
- [08：单图片管理（只读模式）](./08.md)
- [09：多图片管理](./09.md)
- [10：布尔值管理](./10.md)
...
- [19：方法路由与业务鉴权](./19.md)
- [20：整合 Redis](./20.md)
- [21：整合 Elasticsearch](./21.md)
- [22：后端开发规范：tio-boot、java-db 与 Kv](./22.md)
