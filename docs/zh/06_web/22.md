...
import nexus.io.tio.boot.server.TioBootServer;
import nexus.io.tio.boot.admin.handler.GlobalExceptionHadler;
...
2024-02-04 10:12:36.683 [tio-group-3] INFO  c.l.t.w.h.h.GlobalExceptionHadler.handler:27 - /exception,{sec-fetch-mode=navigate, sec-fetch-site=none, accept-language=en-US,en;q=0.9,zh-CN;q=0.8,zh;q=0.7, cookie=PHPSESSID=45ab823cf4424734b764d8888b77130e, sec-fetch-user=?1, accept=text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7, sec-ch-ua="Not A(Brand";v="99", "Google Chrome";v="121", "Chromium";v="121", sec-ch-ua-mobile=?0, sec-ch-ua-platform="Windows", host=localhost, upgrade-insecure-requests=1, connection=keep-alive, cache-control=max-age=0, accept-encoding=gzip, deflate, br, user-agent=Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36, sec-fetch-dest=document},null,java.lang.ArithmeticException: / by zero
	at nexus.io.tio.web.hello.controller.ExceptionController.index(ExceptionController.java:9)
	at nexus.io.tio.web.hello.controller.ExceptionControllerMethodAccess.invoke(Unknown Source)
	at com.esotericsoftware.reflectasm.MethodAccess.invoke(MethodAccess.java:39)
	at nexus.io.tio.boot.http.handler.HandlerDispatcher.executeAction(HandlerDispatcher.java:73)
	at nexus.io.tio.boot.http.handler.DefaultHttpRequestHandlerDispather.processDynamic(DefaultHttpRequestHandlerDispather.java:374)
	at nexus.io.tio.boot.http.handler.DefaultHttpRequestHandlerDispather.handler(DefaultHttpRequestHandlerDispather.java:305)
	at nexus.io.tio.http.server.HttpServerAioHandler.handler(HttpServerAioHandler.java:94)
	at nexus.io.tio.boot.server.TioBootServerHandler.handler(TioBootServerHandler.java:140)
	at nexus.io.tio.core.task.HandlerRunnable.handler(HandlerRunnable.java:67)
	at nexus.io.tio.core.task.DecodeRunnable.handler(DecodeRunnable.java:55)
	at nexus.io.tio.core.task.DecodeRunnable.decode(DecodeRunnable.java:205)
	at nexus.io.tio.core.ReadCompletionHandler.completed(ReadCompletionHandler.java:83)
	at nexus.io.tio.core.ReadCompletionHandler.completed(ReadCompletionHandler.java:21)
...
, line 6, column 1, fastjson-version 2.0.53
{
	...
	at nexus.io.tio.utils.json.FastJson2Utils.parseObject(FastJson2Utils.java:48)
	at nexus.io.llm.handler.ApiChatAskHandler.send(ApiChatAskHandler.java:31)
	at nexus.io.tio.boot.http.handler.internal.TioBootHttpRequestDispatcher.handler(TioBootHttpRequestDispatcher.java:327)
	at nexus.io.tio.http.server.HttpServerAioHandler.handler(HttpServerAioHandler.java:82)
	at nexus.io.tio.boot.server.TioBootServerHandler.handler(TioBootServerHandler.java:177)
	at nexus.io.tio.core.task.HandlePacketTask.handle(HandlePacketTask.java:71)
	at nexus.io.tio.core.task.DecodeTask.decode(DecodeTask.java:144)
	at nexus.io.tio.core.ReadCompletionHandler.completed(ReadCompletionHandler.java:77)
	at nexus.io.tio.core.ReadCompletionHandler.completed(ReadCompletionHandler.java:24)
...
import nexus.io.tio.boot.constatns.TioBootConfigKeys;
import nexus.io.tio.boot.exception.TioBootExceptionHandler;
import nexus.io.tio.http.common.HttpRequest;
import nexus.io.tio.http.common.utils.HttpIpUtils;
import nexus.io.tio.utils.environment.EnvUtils;
import nexus.io.tio.utils.network.IpUtils;
import nexus.io.tio.utils.notification.AlarmUtils;
import nexus.io.tio.utils.notification.NotifactionWarmModel;
