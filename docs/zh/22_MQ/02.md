...
首先，`<dependency>`部分是 Maven 构建配置，用于在的项目中包含 Eclipse Paho MQTT 客户端库。
...
```java
package com.litongjava.mq.paho.config;
...
import com.litongjava.mq.paho.MqttClientUtils;
import com.litongjava.mq.paho.SampleCallback;
...
```java
package com.litongjava.mq.controller;
import org.eclipse.paho.client.mqttv3.MqttMessage;
