...
nexus.io.db.activerecord.ActiveRecordException: ERROR: there is no unique or exclusion constraint matching the ON CONFLICT specification
    at nexus.io.db.activerecord.DbPro.update(DbPro.java:443)
    at nexus.io.db.activerecord.DbPro.update(DbPro.java:477)
    at nexus.io.db.activerecord.Db.updateBySql(Db.java:207)
