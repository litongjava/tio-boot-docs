...
```java
package nexus.io.open.chat.interceptor;

import com.google.firebase.auth.FirebaseAuth;
import com.google.firebase.auth.FirebaseToken;
import com.jfinal.kit.StrKit;
import nexus.io.tio.boot.http.TioHttpContext;
...
```java
package nexus.io.max.blog.config;
...
```java
package nexus.io.max.blog.inteceptor;
