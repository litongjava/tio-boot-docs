...
```java
package nexus.io.telegram.bot.bots;
...
import nexus.io.gpt.translator.bots.MyAmazingBot;
import nexus.io.telegram.can.TelegramClientCan;
...
import nexus.io.telegram.bot.services.StartService;
import nexus.io.telegram.utils.LongPollingMultiThreadUpdateConsumer;
...
```java
package nexus.io.telegram.bot.services;
...
import nexus.io.telegram.can.TelegramClientCan;
import nexus.io.telegram.utils.ReplyKeyboardUtils;
