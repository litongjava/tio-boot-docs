...
c1 = "[ -d /data/apps/tio-boot-full-thin ] && cp -r /data/apps/tio-boot-full-thin backup/tio-boot-full-thin-backup-$(date +'%Y%m%d_%H%M%S')"
c2 = "mkdir -p /data/apps/tio-boot-full-thin"
