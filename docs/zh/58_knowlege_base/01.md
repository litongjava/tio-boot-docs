...
#### 20. `max_kb_paragraph_summary_cache`

```sql
drop table if exists max_kb_paragraph_summary_cache;
...
#### 21.libre_office_converted_cache

```
-- 如果表存在则删除
DROP TABLE IF EXISTS "libre_office_converted_maping";

-- 创建表
CREATE TABLE "public"."libre_office_converted_maping" (
  "id" BIGINT NOT NULL PRIMARY KEY,
