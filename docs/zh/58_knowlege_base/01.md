...
CREATE TABLE "public"."max_kb_application" (
  ...
  multiple_rounds_dialogue default true,
...
#### 21. max_kb_web_page_cache

```sql
CREATE TABLE "public"."max_kb_web_page_cache" (
  "id" BIGINT NOT NULL PRIMARY KEY,
  "url" VARCHAR,
  "content" VARCHAR NOT NULL,
  "remark" VARCHAR(256),
...
CREATE INDEX "max_kb_web_page_cache_url" ON "max_kb_web_page_cache" USING btree (
