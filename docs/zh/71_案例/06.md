...
import nexus.io.open.chat.services.VectorService;
...
```java
import nexus.io.open.chat.spider.sjsu.SJSUClassSchedulePipeline;
import nexus.io.open.chat.spider.sjsu.SJSUClassScheduleProcessor;
...
import nexus.io.table.utils.SnowflakeIdUtils;
...
import nexus.io.tio.utils.string.StrUtils;
...
```
nexus.io.open.chat.task.TaskForPerHour = 0 0 */1 * * ?
```
...
import nexus.io.jfinal.aop.Aop;
import nexus.io.open.chat.services.SJSUClassScheduleService;
...
import nexus.io.table.utils.MarkdownTableUtils;
...
public class ClassLLMAskTest {
  ...
  public void test() {
    ...
    // 初始提示词
    messages.add(new ChatMessage("system", "是一个课程助手"));
    // 数据
