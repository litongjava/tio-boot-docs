...
```java
package nexus.io.study.netty.boot;

import nexus.io.annotation.AComponentScan;
import nexus.io.hotswap.wrapper.netty.boot.NettyApplicationWrapper;
...
当看到以下日志时，表示 `HotSwapClassLoader` 成功加载：
...
2024-10-01 23:24:17.364 [main] INFO  c.l.h.w.n.b.NettyApplicationWrapper.runDev:83 - new hotswap class loader:nexus.io.hotswap.classloader.HotSwapClassLoader@c818063
```

此时，`HotSwapWatcher` 已经启动，它会持续监控 `.class` 文件的变化。只需修改任意 Java 文件，并保存和编译，编译成功后 `HotSwapWatcher` 会通知 `Netty` 重启服务器，新的类将通过 `HotSwapClassLoader` 重新加载。
...
2024-10-01 23:24:18.032 [main] INFO  c.l.s.n.b.c.WebConfig.config:23 - :nexus.io.netty.boot.server.NettyBootServer@42e99e4a
2024-10-01 23:24:18.033 [main] INFO  c.l.s.n.b.c.WebConfig.config:39 - :nexus.io.netty.boot.http.DefaultHttpReqeustRouter@37afeb11,nexus.io.netty.boot.websocket.DefaultWebsocketRouter@515aebb0
2024-10-01 23:24:18.033 [main] INFO  c.l.n.b.c.NettyApplicationContext.run:121 - :nexus.io.netty.boot.server.NettyBootServer@42e99e4a,nexus.io.netty.boot.http.DefaultHttpReqeustRouter@37afeb11,nexus.io.netty.boot.websocket.DefaultWebsocketRouter@515aebb0
2024-10-01 23:24:18.033 [main] INFO  c.l.n.b.c.NettyApplicationContext.run:123 - http  mapping
{
  "/echo": "nexus.io.study.netty.boot.config.WebConfig$$Lambda$14/692331943@222545dc",
  "/txt": "nexus.io.study.netty.boot.config.WebConfig$$Lambda$12/1287934450@5c5eefef",
  "/test": "nexus.io.study.netty.boot.config.WebConfig$$Lambda$15/166794956@16293aa2",
  "/json": "nexus.io.study.netty.boot.config.WebConfig$$Lambda$13/6519275@5158b42f"
}
2024-10-01 23:24:18.033 [main] INFO  c.l.n.b.c.NettyApplicationContext.run:124 - websocket  mapping
{
  "/ws": "nexus.io.study.netty.boot.config.WebConfig$$Lambda$16/1388278453@595b007d"
}
...
2024-10-01 23:29:24.235 [pool-1-thread-1] INFO  c.l.h.w.HotSwapWatcher.process:165 - restart server:nexus.io.hotswap.wrapper.netty.boot.NettyBootRestartServer@465d89fc
loading
...
2024-10-01 23:29:24.242 [pool-1-thread-1] INFO  c.l.h.w.n.b.NettyBootRestartServer.restart:36 - new classLoader:nexus.io.hotswap.classloader.HotSwapClassLoader@1c957b32
...
2024-10-01 23:29:24.273 [pool-1-thread-1] INFO  c.l.s.n.b.c.WebConfig.config:23 - :nexus.io.netty.boot.server.NettyBootServer@763ff22e
2024-10-01 23:29:24.275 [pool-1-thread-1] INFO  c.l.s.n.b.c.WebConfig.config:39 - :nexus.io.netty.boot.http.DefaultHttpReqeustRouter@54fad307,nexus.io.netty.boot.websocket.DefaultWebsocketRouter@149b04a0
2024-10-01 23:29:24.275 [pool-1-thread-1] INFO  c.l.n.b.c.NettyApplicationContext.run:121 - :nexus.io.netty.boot.server.NettyBootServer@763ff22e,nexus.io.netty.boot.http.DefaultHttpReqeustRouter@54fad307,nexus.io.netty.boot.websocket.DefaultWebsocketRouter@149b04a0
2024-10-01 23:29:24.275 [pool-1-thread-1] INFO  c.l.n.b.c.NettyApplicationContext.run:123 - http  mapping
{
  "/echo": "nexus.io.study.netty.boot.config.WebConfig$$Lambda$22/1614062723@577a413a",
  "/txt": "nexus.io.study.netty.boot.config.WebConfig$$Lambda$20/1517207008@7cc86adf",
  "/test": "nexus.io.study.netty.boot.config.WebConfig$$Lambda$23/2051493076@7ea8ecaa",
  "/json": "nexus.io.study.netty.boot.config.WebConfig$$Lambda$21/1762886925@325a59db"
}
2024-10-01 23:29:24.275 [pool-1-thread-1] INFO  c.l.n.b.c.NettyApplicationContext.run:124 - websocket  mapping
{
  "/ws": "nexus.io.study.netty.boot.config.WebConfig$$Lambda$24/1255942322@37acbd3b"
}
