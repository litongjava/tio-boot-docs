...
| 命令码 | 名称                         | 描述             |
| ------ | ---------------------------- | ---------------- |
| 0      | COMMAND_ERROR                | 错误信息         |
| 1      | COMMAND_ACK                  | 确认消息         |
| 3      | COMMAND_LOGIN_REQ            | 登录请求         |
| 4      | COMMAND_LOGIN_RESP           | 登录响应         |
| 5      | COMMAND_AUTH_REQ             | 鉴权请求         |
| 6      | COMMAND_AUTH_RESP            | 鉴权响应         |
| 7      | COMMAND_HEARTBEAT_REQ        | 心跳请求         |
| 8      | COMMAND_HEARTBEAT_RESP       | 心跳响应         |
| 9      | COMMAND_CLOSE_REQ            | 退出请求         |
| 10     | COMMAND_CLOSE_RESP           | 退出响应         |
| 11     | COMMAND_CHAT_REQ             | 聊天消息请求     |
| 12     | COMMAND_CHAT_RESP            | 聊天消息响应     |
| 13     | COMMAND_MESSAGE_READ_REQ     | 已读请求         |
| 14     | COMMAND_MESSAGE_READ_RESP    | 已读响应         |
| 15     | COMMAND_RECALL_MSG_REQ       | 撤回消息请求     |
| 16     | COMMAND_RECALL_MSG_RESP      | 撤回消息响应     |
| 17     | COMMAND_FORWARD_MSG_REQ      | 消息转发请求     |
| 18     | COMMAND_FORWARD_MSG_RESP     | 消息转发响应     |
| 19     | COMMAND_GET_USER_REQ         | 获取用户信息请求 |
| 20     | COMMAND_GET_USER_RESP        | 获取用户信息响应 |
| 21     | COMMAND_CREATE_GROUP_REQ     | 创建群请求       |
| 22     | COMMAND_CREATE_GROUP_RESP    | 创建群响应       |
| 23     | COMMAND_DISBAND_GROUP_REQ    | 解散群请求       |
| 24     | COMMAND_DISBAND_GROUP_RESP   | 解散群响应       |
| 25     | COMMAND_INVITE_TO_GROUP_REQ  | 邀请加入群请求   |
| 26     | COMMAND_INVITE_TO_GROUP_RESP | 邀请加入群响应   |
| 27     | COMMAND_JOIN_GROUP_REQ       | 加入群请求       |
| 28     | COMMAND_JOIN_GROUP_RESP      | 加入群响应       |
| 29     | COMMAND_LEAVE_GROUP_REQ      | 退出群请求       |
| 30     | COMMAND_LEAVE_GROUP_RESP     | 退出群响应       |
| 31     | COMMAND_MUTE_GROUP_REQ       | 屏蔽群请求       |
| 32     | COMMAND_MUTE_GROUP_RESP      | 屏蔽群响应       |
| 33     | COMMAND_GROUP_MESSAGE_REQ    | 群发消息请求     |
| 34     | COMMAND_GROUP_MESSAGE_RESP   | 群发消息响应     |
