...
1. [简介](#简介)
2. [准备工作](#准备工作)
   - [删除 Webhook 地址](#删除-webhook-地址)
   - [申请 Telegram API ID 和 Hash](#申请-telegram-api-id-和-hash)
3. [项目配置](#项目配置)
   - [添加依赖](#添加依赖)
4. [开发实现](#开发实现)
   - [TelegramTranslateBot](#telegramtranslatebot)
